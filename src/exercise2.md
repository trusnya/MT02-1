...
Сценарий№2. Проверка отказа сортировки наименований товаров по алфавиту от A до Z  
1. Нажми на кнопку сортировки товаров в верхнем углу сайта под кнопкой с изображением продуктовой тележки.  
2. Выбери Name (A to Z)  

Сценарий№3. Проверка отказа сортировки наименований товаров по алфавиту от Z до A  
1. Нажми на кнопку сортировки товаров в верхнем углу сайта под кнопкой с изображением продуктовой тележки.  
2. Выбери Name (Z to A)  

Cценарий№4. Проверка отказа сортировки наименований товаров по цене ( от дешёвых к дорогим)  
1. Нажми на кнопку сортировки товаров в верхнем углу сайта под кнопкой с изображением продуктовой тележки.  
2. Выбери Price (Low to High)  

Cценарий№5. Проверка отказа сортировки наименований товаров по цене (от дорогих к дешёвым)  
1. Нажми на кнопку сортировки товаров в верхнем углу сайта под кнопкой с изображением продуктовой тележки.  
2. Выбери Price (High to Low)  

Сценарий№6. Проверка добавления товара в корзину с карточки товара  
1. Выбрать один любой товар  
2. Нажать кнопку с названием товара    
4. Нажать на кнопку "Add to cart"      

Сценарий№7. Проверка перехода с карточки товара на главную страницу сайта:   
1. Нажать на кнопку "Back to products" 

Сценарий№8. Проверка добавления товара в корзину с главной страницы сайта:    
1. Выбрать один любой товар или группу    
2. Нажать на кнопку "Add to cart"     

Сценарий№9. Проверка удаления товара из корзины:  
...
Сценарий№10. Проверка удаления товара из корзины через карточку товара  
1. Выбрать один добавляющийся товар или группу   
2. Нажать на кнопку "Add to cart"  
3. Нажать кнопку с названием товара  
4. Нажать кнопку "Remove"  

Сценарий№11. Проверка удаления товара из корзины с главной страницы сайта  
1. Выбрать один любой товар или группу    
2. Нажать на кнопку "Add to cart"  
3. Выбрать любой товар  
4. Нажать на кнопку "Remove"  

Сценарий№12. Проверка удаления товара из корзины с помощью бокового меню сайта (применить к главной странице, странице ввода данных при оплате заказа, страница чека после оплаты заказа, страница цспешной оплаты заказа)   
1. Выбрать один добавляющийся товар или группу    
2. Нажать на кнопку "Add to cart" 
3. Нажать на кнопку с изображением продуктовой тележки  
4. Нажать кнопку меню в левом верхнем углу сайта  
