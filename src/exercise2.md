...
Сценарий№58. Проверка успешного выхода из авторизации (применить к главной странице,странице карточки товара, странице ввода данных при оплате заказа, странице чека после оплаты заказа, странице успешной оплаты заказа, информационный сайт о компании) 
1. Нажать кнопку меню в левом верхнем углу сайта  
2. Нажать кнопку "Logout"  
